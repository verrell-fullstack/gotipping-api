...
function Header({btnToggle, setBtnToggle, reference, userLogged, setuserLogged, loginOpen, setLoginOpen, useHistory}) {
  ...
  return (
    <>
      {
        userID ? (
          <header className={classnames("header bg-royal-blue logged-in")}>
